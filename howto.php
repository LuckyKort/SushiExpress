                ...
                <ul class="nav navbar-nav">
					...
					<li class="dropdown active">
					  ...
					  <ul class="dropdown-menu" style="font-size: 14px;">
						...
						<li class="active"><a href="/howto.php">Как заказать</a></li>
	...
	<div class="container">
		...
		<div class="row">
			  <div class="col-sm-15 col-md-15">
				<div class="thumbnail">
				  <img src="howto.png" alt="...">
				  <div class="caption">
					<h4>Как сделать заказ</h4>
					Чтобы заказать суши в нашем магазине необходимо выполнить всего несколько просых шагов:
					<br>1. Зарегистрироваться на сайте, авторизоваться под своим логином.
					<br>2. Выбрать суши по вкусу, задать в корзине нужное количество.
					<br>3. Нажать кнопку "Меню" - "Оформить заказ" и ввести необходимые данные.
					<br>4. Ответить на звонок оператора.
					<br>5. Дождаться курьера. Совершить оплату.
					<br>6. Наслаждатся горячими роллами.<br>
					<br><h4>Доставка заказа</h4>
					После оформления заказа с вами свяжется наш менеджер и обговорит с вами детали вашего заказа, такие как количество приборов, этаж, на котором вы живёте, и время доставки.  
					<br>Мы предпримем 3 попытки дозвонится до вас, и, в случае, если с вами не удалось связаться, заказ считается отменённым. 
					<br><b>При регистрации указывайте действительный E-Mail, поскольку на него придёт электронный чек. В случае непредвиденных обстоятельств он будет служить документом, подтверждающим ваш заказ.</b>
				  </div>
				</div>
			  </div>
			</div>
