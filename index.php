...
<head>
	...
	<link href='https://fonts.googleapis.com/css?family=PT+Sans&subset=cyrillic-ext,cyrillic,latin-ext,latin' rel='stylesheet' type='text/css'>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<? if (empty($_SESSION['login']) or empty($_SESSION['id']))
									{?>
										<a style="cursor: default" href='#'><span class="hidden-xs hidden-sm glyphicon glyphicon-user"></span> Гость</a>
									<?}
								else
									{?>
										<a style="cursor: default" href='#'><span class="hidden-xs hidden-sm glyphicon glyphicon-user"></span> <?print $username;?></a>
									<?}
						?>
					</li>
					<li>
	...
	<div class="container">
			...
			<p class="lead">Поиск товаров</p>
				<div class="list-group2">
					...
					<div class="input-group">
						<input type="text" class="form-control" name="query" placeholder="Что будем искать?">
								...
								<td><h4 style="margin-top: 2px;"><?php echo $_SESSION['product_title'][$i]?></h4></td>	
									...
									<div class="input-group input-group-sm">
										...
										<div class="input-group-btn">
											<button type="submit" class="btn btn-default bnt"><span class="glyphicon glyphicon-refresh"></span></button>
										</div>
									</div>
									</form>
									</label>
		...
		<div class="col-md-9">
			<?if(empty($_SESSION[searchids])) {
				...
				<div class="row carousel-holder" style="margin-bottom:15px;">
					<div class="col-md-12">
					<center><button class="btn btn-primary"><h3 style="margin-top: 0px; margin-bottom: 0px;">Результаты поиска по запросу "<? echo $_REQUEST['query'];?>":</h3></button></center>
					</div>
				</div>
				<?}?>
			<div class="row">
				...
				<div class="col-sm-4 col-lg-4 col-md-4">
					<div class="thumbnail">
						<?php
						if ($product['hit'] == 1) { ?>
						<!--<button class="btn btn-xs btn-danger" style="position: absolute; top: 10px; left: 10px;"><span style="font-family:Arial;"><span class="glyphicon glyphicon-star"></span> Хит продаж</span></button>-->
						   <div class="ribbon" style="margin-left: 15px;"><span>Хит продаж</span></div>
						<?}
						if ($_SESSION['adm'] == 1) { ?>
						<button class="btn btn-xs btn-warning hidden-xs" style="position: absolute; right: 28px; bottom: 133px;"><span class="price"><?php echo $product['price'];?> &#8381;</span></button>
						<button class="btn btn-xs btn-warning visible-xs" style="position: absolute; right: 28px; bottom: 113px;"><span class="price"><?php echo $product['price'];?> &#8381;</span></button>
						<?}else{?>
						<button class="btn btn-xs btn-warning hidden-xs" style="position: absolute; right: 28px; bottom: 101px;"><span class="price"><?php echo $product['price'];?> &#8381;</span></button>
						<button class="btn btn-xs btn-warning visible-xs" style="position: absolute; right: 28px; bottom: 79px;"><span class="price"><?php echo $product['price'];?> &#8381;</span></button>
						<?}
						?>
						...
						<div class="caption">
							...
							<center>
								...
								<form action='/editprod.php' method="post">
									...
									<input type="hidden" name="edithit" value="<?php echo $product['hit']?>">
