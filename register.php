				...
				<div class="page-header">
					...
					function prov_adress(obj) {
						  ...
						  if (prov==true &&  prov1==true) {
								...
								alert("Введённые вами пароль или email некорректны!");
								return false;
						  }
						}
					...
					<form name="reg" action="save_user.php" method="post" onSubmit="return(splash() && checkPass()) && prov_adress(reg);">
						<div class="input-group">
							<span class="input-group-addon">Логин: </span>
							<input name="login" type="text" size="15" maxlength="10" class="form-control" placeholder="Максимум 10 символов">
						</div><br>
						<div class="input-group">
							<span class="input-group-addon">Пароль: </span>
							<input name="password" type="password" size="15" maxlength="15" class="form-control" placeholder="Максимум 15 символов">
						</div><br>
						<div class="input-group">
							<span class="input-group-addon">Пароль: </span>
							<input name="password2" type="password" size="15" maxlength="15" class="form-control" placeholder="Повторите ввод пароля">
						</div><br>
						<div class="input-group">
							<span class="input-group-addon">E-Mail: </span>
							<input name="email" type="text" size="15" maxlength="30" class="form-control" placeholder="Введите ваш E-Mail">
						</div><br>
							<button type="submit" name="submit" class ="btn btn-success btn-group">Зарегистрироваться</button>
					</form>
					</div>
					 </center>
			</div>
